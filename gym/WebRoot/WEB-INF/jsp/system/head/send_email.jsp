	...
	<head>
		...
		<script type="text/javascript">
			...
			function sendEm(){
				...
				$.ajax({
					type: "POST",
					url: '<%=basePath%>/head/sendEmail.action?tm='+new Date().getTime(),
			...
			function editEmail(){
			   var EMAIL = $("#EMAIL").val();
			   var result = showModalDialog("<%=basePath%>/head/editEmail.action?EMAIL="+EMAIL,"","dialogWidth=600px;dialogHeight=380px;");
