...
<body>
	<form action="user/${msg }.action" name="userForm" id="userForm" method="post">
		...
		<div id="zhongxin">
		<table class="clearfix dis" style="table-layout:fixed;word-wrap:break-word;">
			<tr>
				<td colspan="2" style="color:gray;">用户信息</td>
			</tr>
			<tr>
				<td>昵称: </td>
				<td>${info.nickname }</td>
			...
			<tr>
				<td>密码: </td>
				<td><input readonly="readonly" type="password" value="${info.password }" /></td>
			</tr>
			<tr>
				<td>用户头像: </td>
				<td>
				<c:if test="${not empty info.avatar}">
					<img src="${info.avatar}" title="用户头像" style="width:200px;height:200px;"/>
				</c:if>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td >关联设备: </td>
				<td><div>${info.deviceids}</div></td>
			</tr>
			<tr>
				<td >我加的好友: </td>
				<td><div>${info.join_friends}</div></td>
			</tr>
			<tr>
				<td >加我的好友: </td>
				<td><div>${info.friendids}</div></td>
			</tr>
			<tr>
				<td>所在地: </td>
				<td>${info.city}</td>
