...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="syssver/feedback_list.action" method="post" name="userForm" id="userForm">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function delUser(userId){
			bootbox.confirm("确定要删除该条反馈吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "syssver/delfeedback.action?id="+userId+"&tm="+new Date().getTime();
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: 'syssver/delAllFeedBack.action?tm='+new Date().getTime(),
						    	data: {USER_IDS:str},
								dataType:'json',
