...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<div id="main-content" class="clearfix">
			...
			<div>
				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="tab.action" style="margin:0 auto;width:100%;height:100%;"></iframe>
<!-- 				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="measure/list.action" style="margin:0 auto;width:100%;height:100%;"></iframe> -->
			</div>
