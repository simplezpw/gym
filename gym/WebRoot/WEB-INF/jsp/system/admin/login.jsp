		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group normal_text">
					<h3>
						<!-- <img src="static/login/logo.png" alt="Logo" /> -->咚咚爱家后台管理
					</h3>
				</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			...
			if(check()){
				...
				var code = loginname+",vooda,"+password+",vooda,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login.action?tm='+new Date().getTime(),
			    	//data: {KEYDATA:code},
					...
					success: function(data){
						if("success" == data.result){
							saveCookie();
							window.location.href="login_index.action";
