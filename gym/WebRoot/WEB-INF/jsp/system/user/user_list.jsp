...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="user/listUsers.action" method="post" name="userForm" id="userForm">
			<table>
				<tr>
					<td>
					...
					<td style="vertical-align:top;"><a class="btn btn-mini btn-light" onclick="window.location.href='<%=basePath%>/user/listtabUsers.action';" title="切换模式"><i id="nav-search-icon" class="icon-exchange"></i></a></td>
