...
<body>
	<form action="user/readExcel.action" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/user/downExcel.action'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
