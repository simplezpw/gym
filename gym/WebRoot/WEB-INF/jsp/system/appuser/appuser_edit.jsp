...
<script type="text/javascript">
	...
	function hasU(){
		...
		var url = "happuser/hasU.action?USERNAME="+USERNAME+"&tm="+new Date().getTime();
	...
	function hasE(USERNAME){
		var EMAIL = $("#EMAIL").val();
		var url = "happuser/hasE.action?EMAIL="+EMAIL+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
	...
	function hasN(USERNAME){
		...
		var url = "happuser/hasN.action?NUMBER="+NUMBER+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
...
<body>
	<form action="happuser/${msg }.action" name="userForm" id="userForm" method="post">
