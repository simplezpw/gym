...
<script type="text/javascript">
	...
	function delP(PATH,PICTURES_ID){
		 if(confirm("确定要删除图片？")){
			var url = "pictures/deltp.action?PATH="+PATH+"&PICTURES_ID="+PICTURES_ID+"&guid="+new Date().getTime();
...
<body>
	<form action="pictures/${msg }.action" name="Form" id="Form" method="post" enctype="multipart/form-data">
