 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',vooda,' + dtype + ',vooda,' + dbz + ',vooda,' + isQian + ',vooda,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',vooda,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',vooda,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',vooda,')[0];
			if(array0 == value){
				return false;
			}
		}
