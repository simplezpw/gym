 ...
 */
package com.vooda.im.appserver;
...
public class Pusher {
	...
	public static void main(String[] args) {
		...
		try {
			...
			result = pusher.push0x20Message(StringUtil.md5Byte("0"),
					"cmd=ntfurl|title=通知标题|content=通知内容|tt=提示标题|url=/m/admin/eml/inbox/listcmd=ntfurl|title=通知标题|content=通知内容|tt=提示标题|url=/m/admin/eml/inbox/listcmd=ntfurl|title=通知标题|content=通知内容|tt=提示标题|url=/m/admin/eml/inbox/list".getBytes("UTF-8"));
			// result =
