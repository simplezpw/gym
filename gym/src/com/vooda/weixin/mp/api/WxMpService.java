...
import com.vooda.weixin.common.bean.WxJsapiSignature;
...
import com.vooda.weixin.mp.bean.*;
import com.vooda.weixin.mp.bean.result.*;
...
public interface WxMpService {
	 ...
	 * @return
	 * @throws com.vooda.weixin.common.exception.WxErrorException
	 */
	 ...
	 * </pre>
	 * @param mediaType 媒体类型, 请看{@link com.vooda.weixin.common.api.WxConsts}
	 * @param fileType 文件类型，请看{@link com.vooda.weixin.common.api.WxConsts}
	 ...
	 * @param news
	 * @throws WxErrorException
	 * @see #massGroupMessageSend(com.vooda.weixin.mp.bean.WxMpMassGroupMessage)
	 * @see #massOpenIdsMessageSend(com.vooda.weixin.mp.bean.WxMpMassOpenIdsMessage)
	 */
	 ...
	 * <pre>
	 * 分组群发消息
	 * 如果发送图文消息，必须先使用 {@link #massNewsUpload(com.vooda.weixin.mp.bean.WxMpMassNews)} 获得media_id，然后再发送
	 * 如果发送视频消息，必须先使用 {@link #massVideoUpload(com.vooda.weixin.mp.bean.WxMpMassVideo)} 获得media_id，然后再发送
	 * 详情请见: http://mp.weixin.qq.com/wiki/index.php?title=高级群发接口
	 * </pre>
	 * @param message
	 * @throws WxErrorException
	 ...
	 * 可以参考，{@link com.vooda.weixin.common.util.http.MediaUploadRequestExecutor}的实现方法
	 * </pre>
	 * @param executor
	 * @param uri
	 * @param data
